...
import { CSV_FILE_TYPE, JSON_FILE_TYPE, NDJSON_FILE_TYPE, TXT_FILE_TYPE } from './common/constants';

export const configSchema = schema.object({
  enabled: schema.boolean({ defaultValue: false }),
  enabledFileTypes: schema.arrayOf(schema.string(), {
    defaultValue: [CSV_FILE_TYPE, JSON_FILE_TYPE, NDJSON_FILE_TYPE, TXT_FILE_TYPE],
  }),
